...
TweenMax.from('.home__liquid', 2.5, {delay: .7, opacity: 0, y: 200,ease: Expo.easeInOut})
TweenMax.from('.home__juice-animate', 2.5, {delay: 1.2, opacity: 0, y: -800,ease: Expo.easeInOut})
TweenMax.from('.home__apple1', 4.5, {delay: 1.5,opacity: 0,y: -800,ease: Expo.easeInOut})
...
TweenMax.from('.home__leaf:nth-child(4)', 7.5, {delay: 1.6,opacity: 0,y: -800,ease: Expo.easeInOut})
TweenMax.from('.home__leaf:nth-child(5)', 8.5, {delay: 1.7,opacity: 0,y: -800,ease: Expo.easeInOut})
TweenMax.from('.home__leaf:nth-child(6)', 8.5, {delay: 1.8,opacity: 0,y: -800,ease: Expo.easeInOut})
