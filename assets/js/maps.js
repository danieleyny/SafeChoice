...
function initMapTest() {
  ...
  var markerColumbia = new google.maps.Marker({
    ...
    map: map,
    icon: new google.maps.MarkerImage(
      'http://chart.apis.google.com/chart?chst=d_map_pin_letter&chld=%E2%80%A2|' + '9BCBEB',
      new google.maps.Size(21, 34),
      new google.maps.Point(0,0),
      new google.maps.Point(10, 34)
    )
  ...
  var markerHunter = new google.maps.Marker({
    ...
    map: map,
    icon: new google.maps.MarkerImage(
      'http://chart.apis.google.com/chart?chst=d_map_pin_letter&chld=%E2%80%A2|' + '3F0157',
      new google.maps.Size(21, 34),
      new google.maps.Point(0,0),
      new google.maps.Point(10, 34)
    )
